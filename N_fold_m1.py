...
dataX_D5=np.delete(dataX,[0,1,2,4,5,6,7,8,12,13,15,16,17],axis=1)
# print(np.shape(dataX_D5))
# (1096, 5)
dataX_D12=np.delete(dataX,[0,3,9,10,11,14],axis=1)
# print(np.shape(dataX_D12))
# (1096, 12)
...
plt.title("linear model by different dimension of feature")
plt.xlabel("N-fold")
plt.ylabel("rmse")
plt.legend()
plt.show()