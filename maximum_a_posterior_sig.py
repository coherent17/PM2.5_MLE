...
plt.ylabel("PM2.5")
plt.title("Sigmoidal training(MAP)")
plt.legend()
plt.show()
...
plt.xlabel("the nth data")
plt.ylabel("PM2.5")
plt.title("Sigmoidal testing(MAP)")
plt.legend()
plt.show()
...
plt.ylabel("weight")
plt.title("weights versus features(MAP_Sigmoidal)")
plt.show()
...
plt.xticks(x,labels,rotation='vertical')
plt.ylabel("rmse")
plt.title("Linear regresion(MAP_Sigmoidal)--the impact on remove one feature")
plt.legend()
plt.show()